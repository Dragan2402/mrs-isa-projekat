create table client
(id bigint not null, address varchar(255) not null, city varchar(255) not null,
country varchar(255) not null, deleted boolean not null, email varchar(255) not null,
enabled boolean, first_name varchar(255) not null, last_name varchar(255) not null, last_password_reset_date timestamp,
password varchar(255) not null, password_reset_token varchar(255), password_reset_token_date timestamp,
 penalties integer not null, phone_num varchar(255) not null, picture varchar(255) not null, rating double not null,
  reviews_number integer not null, acc_type integer not null, username varchar(255) not null,
  verified boolean not null, primary key (id));
insert into client (id,address, city, country, deleted, email, enabled,
                  first_name, last_name, last_password_reset_date, password,
                    ...
                    values(1,'Ulica', 'Novi Sad', 'Serbia', false , 'peropero@maildrop.cc', true,
...
insert into client (id,address, city, country, deleted, email, enabled,
                    ...
                    password_reset_token, password_reset_token_date, penalties, phone_num,
                    picture, rating, reviews_number, acc_type, username, verified)
values(2,'Ulica 2', 'Novi Sad 2', 'Serbia', false , 'gage@mail.com', true,
