...
public class ProjekatMrsIsaApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        clientRep.save(clientTemp3);

        Client clientTemp4 = new Client(
                "c4@gmail.com",
                "c4",
                "c",
                "4",
        ...
        clientRep.save(clientTemp4);

        VacationHouseOwner vacHouseOwnerTemp1 = new VacationHouseOwner(
                "dimpet96@gmail.com",
                "dimpet",
                "Dimitrije",
                "Petrov",
        ...
        ShipOwner shipOwnerTemp1 = new ShipOwner("krtolinat@gmail.com",
                "tomo",
                "Tomo",
                "Krtolina",
                "Balkan",
        ...
        FishingInstructor fishingInstructorTemp = new FishingInstructor(
                "aki96@gmail.com",
                "asi",
                "Andrej",
                "Culjak",
        ...
        Slot slotTemp = new Slot(
                ...
                SlotType.FishingClass,
                true
        );
        fishingClassTemp.addSlot(slotTemp);

        Slot slotTemp2 = new Slot(
                LocalDateTime.of(2022, 1, 1, 0, 0, 0, 0),
                SlotType.Ship,
                false
        );
        ...
        Slot slotTemp3 = new Slot(
                LocalDateTime.of(2022, 1, 1, 0, 0, 0, 0),
                SlotType.VacationHouse,
                false
        );
        ...
        List<Slot> slots = slotRep.findAll();
        for (Slot s: slots) {
